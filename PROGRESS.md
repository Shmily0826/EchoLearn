...
- **Production:** serves the build of `31d5f37`, verified behaviourally by bundle markers (no Vercel control-plane read this cycle). AI provider configuration was **not re-verified** this cycle; the last recorded state is Gemini (`AI_PROVIDER=gemini`) manually confirmed in the Vercel Dashboard for Production scope on 2026-09-13, and no secret value is recorded.
