...
- Current Vercel production is the push-triggered deployment `dpl_GAAtbhbfZmjgevm1Pfz1vGeU5n5X`, `READY`, for source-record commit `6176800e59ce4bdd8bb67b60ac78e92fada9e954`; the runtime frontend/API source is unchanged because local `api/transcript.ts` and frontend service changes were excluded. Current app and Worker health endpoints were HTTP 200.
