...
- **CI:** **GREEN** on `31d5f37` (GitHub Actions run `34795278184`): `test` job success (vitest 53 files / 591 tests + Firestore-emulator 10 tests) and `e2e` job success with **46 passed / 0 failed (2.4m)**. The preceding commit `8be5867` was **red** — `e2e/media-sync.spec.ts:132` timed out waiting for the `2x` speed preset that this cycle had removed, giving 45 passed / 1 failed (run `34794561186`); `31d5f37` restored the preset.
