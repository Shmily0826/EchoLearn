...
- **Boundary:** all evidence is local/browser-mocked and provider-free. No `/api/audio-transcribe`, Groq, Supadata, paid provider, production browser, deployment, commit, or push was used for V2. V2 remains an uncommitted LOCAL VERIFIED candidate; existing V1 production acceptance remains the production baseline.
