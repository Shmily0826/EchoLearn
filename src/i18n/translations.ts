...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'tour.doneBody':       { en: 'Last stop — let\'s see how to read a transcript and save useful words and sentences.', zh: '最后一站——看看如何阅读字幕、收藏有用的单词和句子。' },
  ...
  'tour.studyControlsTitle': { en: 'Pick difficulty', zh: '选择难度' },
  'tour.studyControlsBody':  { en: 'Before analyzing, set the CEFR level range (A1 lowest · C2 highest) to match your English level. Word and sentence counts are picked for you automatically.', zh: '分析前，先选定 CEFR 难度区间（A1 最低 · C2 最高）以匹配你的英语水平。要提取的单词数与句子数由系统自动预设。' },
  'tour.studyAnalyzeTitle': { en: 'AI analysis', zh: 'AI 分析' },
  'tour.studyAnalyzeBody':  { en: 'Sign in to use AI analysis. When signed in, it reads the transcript and, based on your chosen CEFR level, pulls out useful vocabulary and example sentences, then writes a short summary with key points.', zh: '登录后可使用 AI 分析。登录后，它会读取字幕，按你选择的 CEFR 难度提取实用词汇与例句，并生成简短摘要和要点。' },
  ...
  'dash.onboardStep2':   { en: 'Read the transcript, save words and sentences', zh: '阅读字幕，保存词汇和句子' },
  ...
  'dash.delete':         { en: 'Delete', zh: '删除' },
    ...
    'dash.selectSessions': { en: 'Select', zh: '选择' },
    'dash.cancelSelect': { en: 'Cancel', zh: '取消' },
    'dash.selectAll': { en: 'Select all', zh: '全选' },
    'dash.clearSelection': { en: 'Clear selection', zh: '取消全选' },
    'dash.deleteSelected': { en: 'Delete selected', zh: '删除所选' },
    'dash.deleteSelectedSessions': { en: 'Delete {n} selected sessions?', zh: '确定删除选中的 {n} 条学习记录吗？' },
    'dash.selectSession': { en: 'Select session', zh: '选择学习记录' },
    'dash.showMoreSessions': { en: 'Show {n} more sessions', zh: '展开剩余 {n} 条' },
  ...
  'localMedia.audioRequirements': { en: 'Supports .mp3, .m4a, and .wav up to 200 MiB. Choose an existing .srt or .vtt subtitle; no transcription is performed.', zh: '支持最大 200 MiB 的 .mp3、.m4a 和 .wav。请选择现有的 .srt 或 .vtt 字幕；不会进行语音转写。' },
  'localMedia.audioTooLarge': { en: 'Local media audio files must be 200 MiB or smaller.', zh: '本地媒体音频文件必须不超过 200 MiB。' },
  'localMedia.storageFailed': { en: 'Could not save this audio locally. Free up browser storage or compress the audio, then try again. Your existing lesson was not changed.', zh: '无法将音频保存到本地。请释放浏览器存储空间或压缩音频后重试。现有课程未被更改。' },
  ...
  'study.fetchElapsed':    { en: 'waited {sec}s', zh: '已等待 {sec}s' },
  'study.fetchingShort': { en: 'Fetching...', zh: '获取中...' },
  'study.words':         { en: 'Words:', zh: '要学生词：' },
  'study.sents':         { en: 'Sents:', zh: '要学句子：' },
  'study.level':         { en: 'Level:', zh: '难度：' },
  'study.levelMin':      { en: 'Minimum CEFR level', zh: 'CEFR 最低难度' },
  'study.levelMax':      { en: 'Maximum CEFR level', zh: 'CEFR 最高难度' },
  'study.studySettings': { en: 'Study settings', zh: '学习设置' },
  ...
  'study.analyzeTooltip': { en: 'AI reads the transcript and picks key vocabulary and useful example sentences matched to your CEFR level — so you study only what matters.', zh: 'AI 通读字幕，按你设定的 CEFR 难度挑出重点单词与实用例句——只学最有价值的内容。' },
  'study.sentence':      { en: 'Sentence', zh: '整句' },
  'study.sentences':     { en: 'sentences', zh: '句' },
  'study.totalLines':    { en: 'subtitles', zh: '条字幕' },
  'study.totalLinesTooltip': { en: 'Total subtitle lines loaded from this video (not what AI analyzes)', zh: '本视频已加载的字幕总行数（并非 AI 实际分析的数量）' },
  ...
  'study.invalidVideo':   { en: 'Enter a valid YouTube or Bilibili video URL or ID.', zh: '请输入有效的 YouTube 或 Bilibili 视频链接或 ID。' },
  ...
  'study.asrRequiredTitle': { en: 'No captions found — generate a transcript?', zh: '未找到字幕 — 要生成转录吗？' },
  'study.asrRequiredReason': { en: 'EchoLearn can transcribe the audio with AI. This may take longer than normal subtitles.', zh: 'EchoLearn 可以使用 AI 转录音频，可能比获取普通字幕花费更长时间。' },
  'study.generateTranscript': { en: 'Generate transcript', zh: '生成转录' },
  'study.asrGenerating': { en: 'Generating…', zh: '正在生成…' },
  'study.asrGeneratingStatus': { en: 'Generating transcript from audio…', zh: '正在从音频生成转录…' },
  'study.asrFailedTitle': { en: 'Transcript generation failed', zh: '转录生成失败' },
  'study.asrFailedReason': { en: 'The audio transcription did not finish. You can retry it explicitly, or use manual subtitles.', zh: '音频转录未完成。你可以再次明确重试，或使用手动字幕。' },
  ...
  'study.supadataLikelyCredit': { en: 'Supadata credit likely used (estimate: 1 request)', zh: 'Supadata 可能消耗 1 次额度（估算：1 次请求）' },
  'study.supadataBrowserEstimate': { en: 'This-browser estimate: {attempts} attempts · {credits} likely credits', zh: '本浏览器估算：{attempts} 次尝试 · 可能消耗 {credits} 次额度' },
  ...
  'study.youtubeFocusMode':   { en: 'Focus / listening mode', zh: '专注 / 听力模式' },
  'study.youtubeFocusModeOn': { en: 'On — YouTube playback stays in sync', zh: '已开启 — YouTube 播放与字幕同步' },
  'study.youtubeFocusModeHint': { en: 'Keep the YouTube player visible while captions stay in sync', zh: '保持 YouTube 播放器可见，字幕继续同步' },
  ...
  'vocab.masteredFilter': { en: 'Mastered', zh: '已掌握' },
  ...
  'vocab.translateRetry':  { en: 'Click to translate', zh: '点击翻译' },
  'vocab.translationComplete': { en: 'All missing translations filled.', zh: '已补全所有缺失翻译。' },
  'vocab.translationPartial': { en: '{count} translation(s) failed. Try again.', zh: '有 {count} 条翻译失败，请重试。' },
  'vocab.translationFailed': { en: 'Translation failed. Try again.', zh: '翻译失败，请重试。' },
  'vocab.retry':          { en: 'Retry', zh: '重试' },
  'vocab.lookupHint':      { en: 'No saved word matches "{term}". Look it up in the dictionary?', zh: '生词本里没有「{term}」，要查词典吗？' },
  'vocab.lookupBtn':       { en: 'Look up', zh: '查词典' },
  ...
  'sent.translationComplete': { en: 'All missing translations filled.', zh: '已补全所有缺失翻译。' },
  'sent.translationPartial': { en: '{count} translation(s) failed. Try again.', zh: '有 {count} 条翻译失败，请重试。' },
  'sent.translationFailed': { en: 'Translation failed. Try again.', zh: '翻译失败，请重试。' },
  ...
  'settings.deleteAccountHint': { en: 'Permanently delete your account, its cloud data, and this device’s study data (audio files and GitHub backup credential included). Feedback sent before 2026-09-20 needs an admin to remove.', zh: '永久删除账号、其云端数据以及本设备的学习数据（含音频文件与 GitHub 备份凭据）。2026-09-20 之前提交的反馈需管理员删除。' },
  ...
  // Deletion is sequenced so a failed step cannot destroy the next one; each
  // failure gets its own honest message rather than one generic error.
  'settings.deletePasswordTitle': { en: 'Confirm it’s you', zh: '确认身份' },
  'settings.deletePasswordBody': { en: 'Deleting an account is a sensitive operation, so Firebase needs a recent sign-in. Enter your password to continue — nothing has been deleted yet.', zh: '删除账号属于敏感操作，Firebase 需要近期登录凭证。请输入密码继续——目前尚未删除任何数据。' },
  'settings.deletePasswordPlaceholder': { en: 'Password', zh: '密码' },
  'settings.deletePasswordProceed': { en: 'Delete my account', zh: '删除我的账号' },
  'settings.deleteErrorNoLocalCopy': { en: 'This device has no copy of your cloud study data, and deleting the cloud copy cannot be undone. Export your data first, or delete the account from the device that holds it.', zh: '本设备没有你云端学习数据的副本，而删除云端数据无法撤销。请先导出你的数据，或改为在持有该数据的设备上删除账号。' },
  'settings.deleteErrorCloud': { en: 'Cloud cleanup did not finish: your learning data was either removed completely or not at all, and this device plus your account are untouched. Retry to finish.', zh: '云端清理未完成：学习数据要么已全部删除、要么完全未删除，本设备数据与账号均未受影响。请重试以完成。' },
  'settings.deleteErrorAccount': { en: 'Cloud data was removed but the account itself was not. Study data on this device is intact — sign in again and retry to finish.', zh: '云端数据已删除，但账号仍然存在。本设备学习数据完好，请重新登录后重试以完成删除。' },
  'settings.deleteErrorDevice': { en: 'The account was deleted, but some data on this device could not be cleared. Reload the page to try again.', zh: '账号已删除，但本设备部分数据无法清除。请刷新页面重试。' },
  'settings.deleteErrorReauthCancelled': { en: 'Sign-in confirmation was cancelled, so nothing was deleted.', zh: '身份确认已取消，因此未删除任何数据。' },
  'settings.deleteErrorReauth': { en: 'Sign-in confirmation failed, so nothing was deleted. Check your password and retry.', zh: '身份确认失败，因此未删除任何数据。请检查密码后重试。' },
  ...
  'ai.localSummary':     { en: 'This transcript contains approximately {wordCount} words across {sentenceCount} sentences. (AI analysis is temporarily unavailable — showing a local summary; try Re-analyze in a moment.)', zh: '本字幕约 {wordCount} 词，共 {sentenceCount} 句。（AI 服务暂时不可用，已显示本地分析结果，可稍后点击“重新分析”重试。）' },
  ...
  'settings.logoutConfirmTitle': { en: 'Sign out?', zh: '退出登录？' },
  'settings.logoutConfirmBody':  { en: "Your email isn't verified yet, so your learning data hasn't been synced to the cloud. If you sign out now, the words, sentences, and study records on this device will be cleared — unsynced data may be unrecoverable.", zh: '你的邮箱尚未验证，学习数据还没有同步到云端。如果现在退出，本设备上的单词、句子和学习记录将被清除，尚未同步的数据可能无法恢复。' },
  'settings.logoutConfirmCancel': { en: 'Cancel', zh: '取消' },
  'settings.logoutConfirmProceed': { en: 'Sign out and clear data', zh: '仍要退出并清除数据' },
  'settings.signingOut': { en: 'Signing out…', zh: '退出中…' },
  ...
  'wordCard.lookupError':     { en: 'Dictionary service unavailable. Please try again.', zh: '词典服务暂时不可用，请稍后重试。' },
  ...
  'study.jumpToTimestamp': { en: 'Jump to this point in the video', zh: '跳转到视频中的这个位置' },
  'study.saveSentenceBookmark': { en: 'Save sentence', zh: '收藏句子' },
  'study.removeSentenceBookmark': { en: 'Remove bookmark', zh: '取消收藏' },
