...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'feedback.subtitle':     { en: 'Tell us what to improve. Leave your email only if you want a reply.', zh: '告诉我们哪里可以做得更好。想收到回复再留下邮箱。' },
  ...
  'feedback.includeEmail': { en: 'Include my email (optional)', zh: '留下我的邮箱（选填）' },
  'feedback.emailPh':      { en: 'your@email.com', zh: '你的邮箱' },
  'feedback.cancel':       { en: 'Cancel', zh: '取消' },
  'feedback.submit':       { en: 'Submit', zh: '提交' },
  'feedback.required':     { en: 'Please enter your feedback.', zh: '请填写反馈内容。' },
  'feedback.emailInvalid': { en: 'Please enter a valid email.', zh: '请输入有效的邮箱地址。' },
  'feedback.sent':         { en: 'Thanks! Your feedback email is ready to send.', zh: '谢谢！反馈邮件已准备好发送。' },
  'feedback.subject':      { en: 'EchoLearn Feedback', zh: 'EchoLearn 反馈' },
