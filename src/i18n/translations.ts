...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'tour.studyControlsBody':  { en: 'Before analyzing, set the CEFR level range and how many words and sentences to extract. We pick a sensible default — tweak it anytime.', zh: '分析前，先设置 CEFR 难度区间，以及要提取的单词数和句子数。我们已预设一个合适的范围，你可以随时调整。' },
  'tour.studyAnalyzeTitle': { en: 'AI analysis', zh: 'AI 分析' },
  'tour.studyAnalyzeBody':  { en: 'Click “Analyze” to extract vocabulary and example sentences graded by CEFR level.', zh: '点击“分析”按钮，按 CEFR 等级提取词汇和例句。' },
  ...
  'study.aiIntro':       { en: 'AI analysis: extracts key vocabulary and useful sentences by your chosen CEFR level, plus summaries and takeaways.', zh: 'AI 分析：按所选 CEFR 难度，从字幕中提取重点词汇与实用句子，并生成摘要与要点。' },
  'study.aiCountNote':   { en: 'You can freely adjust how many words and sentences to extract.', zh: '提取的单词数 / 句子数 均可自由调整。' },
  'study.cefrHint':      { en: '(A1 lowest · C2 highest)', zh: '(A1 最低 · C2 最高)' },
