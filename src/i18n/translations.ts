...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'tour.studySaveTitle':  { en: 'Save words & sentences', zh: '收藏单词与句子' },
  'tour.studySaveBody':   { en: 'Tap any word for its meaning, then tap Save to add it to your vocabulary. Tap the bookmark on a sentence to save it. Both flow into daily review.', zh: '点任意单词查看释义，再点“收藏”加入生词本；点句子上的书签收藏句子。它们都会进入每日复习。' },
  'tour.studyDoneTitle':  { en: 'You’re all set!', zh: '都准备好了！' },
  'tour.studyDoneBody':   { en: 'That’s EchoLearn in a nutshell — pick a video and start learning!', zh: '这就是 EchoLearn 的精髓，挑个视频开始学习吧！' },
